...
var SavePageController = /** @class */ (function (_super) {
    __extends(SavePageController, _super);
    function SavePageController(view, model) {
        var _this = _super.call(this, view) || this;
        _this.model = model;
        return _this;
    }
    SavePageController.prototype.update = function (app) {
        var _this = this;
        app.post('/saveExercise', function (request, response) {
            ...
            var tagsCorrection = _this.correctionToTags(wordsnumber, request.body);
            //building a array merging tags coming from user corrections and hunpos solution
            var finalTags = SavePageController.correctsHunpos(hunposTags, tagsCorrection);
            //saving in the database the final solution for the exercise
            _this.model.writeSolution(sentence.split(" "), finalTags, sentence, key);
     ...
     */
    SavePageController.prototype.correctsHunpos = function (hunposTags, tagsCorrection) {
        var finalTags = [];
     ...
     */
    SavePageController.prototype.correctionToTags = function (wordsnumber, dataCorrection) {
    ...
    return SavePageController;
}(PageController));
exports.SavePageController = SavePageController;

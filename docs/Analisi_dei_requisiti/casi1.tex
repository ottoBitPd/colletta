In questa sezione verranno indicati ed analizzati tutti i casi d'uso individuati dal gruppo. Ogni caso d'uso verrà indicato con un codice univoco secondo le regole descritte nel documento \textit{Norme di progetto} e riportate di seguito. 
...
\subsubsection{UC-4 Verifica richiesta insegnante}
		\begin{itemize}
			...
			\item Estensioni:
			\begin{itemize}
				\item 2.a L'amministratore che verifica la richiesta di insegnante deve confermare o annullare l'operazione (UC-32).
			\end{itemize}
		\end{itemize}
...
\item Estensioni:
\begin{itemize}
	\item 2.a L'amministratore deve confermare o annullare l'operazione di eliminazione utente (UC-32).
\end{itemize}
\end{itemize}

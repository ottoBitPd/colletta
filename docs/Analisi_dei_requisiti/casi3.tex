...
\subsubsection{UC-15 Ricerca dei dati delle annotazioni}
	...
	\subsubsection{UC-15.1.2 Filtraggio dei dati in base agli utenti}	
		\begin{itemize}
			...
			\item \textbf{Scenario principale:}
				\begin{enumerate}
					\item lo sviluppatore sceglie tra le opzioni "Includi utente" e "Escludi utente"
					\item lo sviluppatore cerca gli utenti da includere o escludere (UC-15.1.2.1)
	...
	\subsubsection{UC-15.1.2.1 Ricerca utente}
		\begin{itemize}
			\item \textbf{Attori:} Sviluppatore.
			\item \textbf{Precondizione:} Lo sviluppatore ha scelto se includere o escludere un utente.

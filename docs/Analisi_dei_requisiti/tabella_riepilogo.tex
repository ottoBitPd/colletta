...
\multirow[t]{61}{*}{Interno}		
				...
				&	RDF28 \\
				&	RDF32 \\
				& RDF34\\%Filtraggio in base al ruolo
				& RDF35 \\%Filtraggio in base alla valutazione
				&	RDF36 \\
				&	RDF37 \\
		...
		\rowcolor{LightGray}
		UC-S1.1.2 & RDF32\\
		UC-S1.1.3 & RDF34\\%Filtraggio in base al ruolo
		\rowcolor{LightGray}
		UC-S1.1.4 & RDF35\\%Filtraggio in base alla valutazione
		UC-S1.1.2.1 & RDF33\\
		\rowcolor{LightGray}
		UC-S1.2 & RDF36\\
		UC-S2 & RDF37\\
		...
		UC-S17 & RPF30\\
		\rowcolor{LightGray}		
		UC-S18 & RDF43\\%Visualizzazione Errore
		\hline
...
\begin{longtable}{| p{5cm} | p{5cm} |}
		...
		\rowcolor{LightGray}
		RDF33 & UC-S1.1.2\\
		RDF34 & UC-S1.1.3\\%Filtraggio in base al ruolo
		RDF35 & UC-S1.1.4\\		%Filtraggio in base alla valutazione
		RDF36 & UC-S1.1.2.1 \\
		\rowcolor{LightGray}
		RDF37 & UC-S2\\
		RDF38 & UC-S8\\
		...
		\rowcolor{LightGray}
		RDF42 & UC-S16\\
		RDF43 & UC-S18\\		%Visualizzazione errore
		RPF1 & UC-G3.1\\
		\rowcolor{LightGray}
		RPF2 & UC-G3.2\\
		RPF3 & UC-G3.3\\

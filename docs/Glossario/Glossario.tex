...
\begin{document}
	...
	\index{Capability (capacità) dei processi}
	...
	\index{Validazione}
	È il processo che si assicura che quanto prodotto nel progetto soddisfi i requisiti. Questo processo viene svolto solo sul prodotto finale e coinvolge fortemente il cliente tramite attività di collaudo.
	
	\subsection{Verifica}
	\index{Verifica}
	Esaminare qualcosa per accertarne l'autenticità, l'esattezza e il buon funzionamento.
	È un processo sempre attivo e controlla l'aderenza dei processi al way of working, cercando anche di migliorarlo. Inoltre, si cura che l'esecuzione di specifiche attività non abbia introdotto errori.

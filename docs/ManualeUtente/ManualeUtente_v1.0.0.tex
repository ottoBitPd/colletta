...
\begin{document}
 ...
 \newpage
	...
	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.65]{images/svolgimentoesercizio.jpg}
	...
	\begin{enumerate}
		...
		\item Se hai eseguScegli nel menu a tendina l'autore della correzione;
		\item Cliccare su "Invia".
	\end{enumerate}
	...
	\subsection{Assegnazione ad una classe}
	Questa funzionalità è riservata all'utente di tipo \textbf{Allievo}.
	...
	Nel caso in cui sia necessario segnalare un contenuto che ritieni non debba essere presente nella piattaforma seguire i seguenti passi:
	\begin{enumerate}

...
%-------------VERIFICA--16/12---------------------------------------------------
\begin{comment}
- Indicatore numero pagine a piè di pagina non corretto
- Indice non presente
- Gulpease misurato= 67 -> accettabile ma se possibile migliorarlo
- La sezione “scopo del documento” dice che questo documento serve a formalizzare uno standard per i documenti. Aggiungere che formalizza anche altre cose dato che dopo  nelle sezioni successive si parla anche di codifica e quindi di cose che non centrano con la documentazione
- Compilare il diario delle modifiche
- Sezione 2.1 incompleta.. l’ultima frase non è stata conclusa
- Sezione 4.1.3.5 Più che titolo Una figura dovrebbe avere una  didascalia sotto con scritto: Figura x e una breve descrizione
- 4.2.4.1 Aggiungere correttore texmaker
- 5.1.4 Lo studio di fattibilità viene redatto dall’analista non dal progettista.
- Nella prima parte ci sono delle parentesi ogni tanto dove chi l’ha scritta aveva una dubbio su quale termine usare…risolvere i dubbi
...
0.0.1 & 05/12/2018 & Giovanni Bergo Gianmarco Pettenuzzo & Redattore & Stesura sezione 2 \\ \hline
0.0.1 & 05/12/2018 & Michele Bortone & Verificatore & Verifica documento 

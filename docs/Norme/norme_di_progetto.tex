...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{ c | c | c | c | X }
		...
		0.0.1 & 05/12/2018 & Giovanni Bergo & Redattore & \centering Stesura sezione 2 & 		0.0.2 & 2018-12-13 & Enrico Marcato & Amministratore & \centering Stesura Progettazione
	\end{tabularx}
...
\noindent \\ Documento unico ad uso esterno, consiste di un elenco di definizioni, in ordine lessicografico, di tutte le parole che possono creare ambiguità o necessitanti descrizione precisa. Tutti i termini presenti nel glossario sono marcati con un "*" ogni prima volta che compaiono in un documento (esempio: Glossario*).
	...
	Per la produzione di codice \LaTeX\ è stato utilizzato TexStudio.
...
\noindent \\
Riguardo la validazione dei file nel formato CSS e HTML vengono utilizzati gli strumenti messi a disposizione da W3C.
\paragraph{Validazione JavaScript}
\noindent \\
SonarQube
\\
Jest
...
\item \textbf{Progettista:} effettua lo studio di fattibilità del prodotto, costruisce l’architettura con ottica di efficienza ed efficacia a partire dal lavoro dell’analista;

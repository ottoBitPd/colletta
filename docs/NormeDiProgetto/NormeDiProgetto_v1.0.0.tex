...
\end{itemize}
	...
	\begin{itemize}
	 ...
	 \item Livello ottimale: livello 4 o superiore
	 \end{itemize}
	...
	\end{center}
	I risultati sono compresi tra 0 e 100, dove il valore 100 indica la leggibilità più alta e 0 la leggibilità più bassa. I testi il cui indice è inferiore ad 80 sono difficili da leggere per chi ha la sola licenza elementare, inferiore a 60 per chi ha la licenza media e inferiore a 60 per chi possiede un diploma superiore.
	\begin{itemize}
	 \item Livello di accettazione: superiore a 40
	 \item Livello ottimale: superiore a 60
	 \end{itemize}	
	\end{itemize}
	...
	\begin{itemize}
	 ...
	 \item Livello ottimale: superiore al 80\%
	 \end{itemize}
	...
	\begin{itemize}
	 ...
	 \item Livello ottimale: superiore al 70\%
	 \end{itemize}
...
\begin{itemize}
	...
	Come strumento per la validazione di codice JavaScript viene utilizzato \textit{ESLint}.
...
Continuous integration è una pratica che si applica in contesti in cui lo sviluppo del software avviene attraverso un sistema di versioning. Consiste nell'allineamento frequente dagli ambienti di lavoro degli sviluppatori verso l'ambiente condiviso (mainline).
\subsubsection{Strumenti}
\paragraph{GitLab CI}
\noindent \\

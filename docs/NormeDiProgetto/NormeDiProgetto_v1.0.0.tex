...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{ c | c | p{3.80cm} | c | X }
		...
		3.0.1 & 2019-05-07 & Michele Bortone & Amministratore & Aggiornamento  \S2.2.4 e \S3.1.4\\ \hline
		3.0.0 & 2019-04-11 & Giovanni Bergo & Responsabile & Approvazione per il rilascio \\ \hline
		2.1.0 & 2019-04-11 & Michele Bortone & Verificatore & Documento \newline verificato \\ \hline
...
%	\textbf{Prodotto dell'attività}: \textit{NormeDiProgetto\_v2.0.0}
	...
	\subsubsection{Strumenti per la progettazione}
	\paragraph{Astah\\}
	...
	\begin{itemize}
		\item JavaScript: Node.js per la parte back-end e routing e Javascript per la parte dinamica del front-end

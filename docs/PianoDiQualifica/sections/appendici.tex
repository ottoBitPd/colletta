...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1]{images/resoconto/studiodifattibilita-RR.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1]{images/resoconto/normediprogetto-RR.pdf}
	\caption{Valori ISO/IEC Norme di progetto}	
\end{figure}

\subsubsection{Pianificazione progetto}
\begin{figure}[H]
	\centering
	\includegraphics[scale=1]{images/resoconto/pianificazioneprogetto-RR.pdf}
	\caption{Valori ISO/IEC Pianificazione progetto}	
\end{figure}
\subsubsection{Pianificazione qualifica}
\begin{figure}[H]
	\centering
	\includegraphics[scale=1]{images/resoconto/pianificazionequalifica-RR.pdf}
	\caption{Valori ISO/IEC Pianificazione qualifica}	
\end{figure}

\subsubsection{Analisi dei requisiti}
\begin{figure}[H]
	\centering
	\includegraphics[scale=1]{images/resoconto/analisideirequisiti-RR.pdf}
	\caption{Valori ISO/IEC Analisi dei requisiti}
\end{figure}

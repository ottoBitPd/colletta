...
\subsection{Valori Requirement Stability Index - MPC2}
...
Riportiamo di seguito i calcoli e le varie misurazioni effettuate.
...
\begin{longtable}{>{\centering\arraybackslash}m{3cm} >{\centering\arraybackslash}m{4cm} >{\centering\arraybackslash}m{5cm} >{\centering\arraybackslash}m{2cm}}
	...
	& \textbf{\textcolor{white}{Indice Gulpease}}
	& \textbf{\textcolor{white}{Esito}}\\
	\textit{2019-02-15} & 60 & Accettato\\
	\hline
	\rowcolor{LightGray}
	\textit{2019-02-15} &  & Accettato\\
	\hline
	\textit{2019-02-20} &  & Accettato\\
	\hline
	\rowcolor{LightGray}
	\textit{2019-02-21} &  & Accettato\\
	\hline
	\textit{2019-02-22} &  & Accettato\\
	\hline
	\textit{2019-02-25} &  & Accettato\\
	\hline
	\textit{2019-02-27} &  & Accettato\\
	\hline
	\textit{2019-03-04} &  & Accettato\\
	\hline
	\caption{Resoconto attività di verifica per la revisione dei requisiti}
\end{longtable}

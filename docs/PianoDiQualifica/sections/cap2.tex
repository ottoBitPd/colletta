...
\end{itemize} 
Per la gestione dei test, il team ha deciso di seguire il V-Model* che descrive la relazione tra ogni fase del ciclo di vita dello sviluppo del software e la sua fase di testing.
\begin{figure}[htbp]
		\centering

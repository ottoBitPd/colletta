...
\item \textbf{Test di regressione:} Consiste nell'eseguire nuovamente i test di unità e di integrazione su componenti software che hanno subito delle modifiche, in modo da controllare che i cambiamenti apportati non abbiano pregiudicato il funzionamento.
\end{itemize}

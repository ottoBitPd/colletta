...
\paragraph{Test di sistema}\textcolor{white}{.}
...
\begin{longtable}{|p{3.125cm}|p{3.125cm}|p{3.125cm}|p{3.125cm}|>{\centering\arraybackslash}m{2cm}|}
	...
	\rowcolor{LightBlue}
		...
		\rowcolor{white}
		& Process innovation & & Process definition & \\ 
...
{\renewcommand{\arraystretch}{1.5}%
	...
	\rowcolor{LightBlue}
		...
		& \\ \hline
		\rowcolor{LightGray}
		attributo 1.1 & attributo 1.2 & attributo 1.3 & attributo 1.4 & Livello\\
		\rowcolor{white}
		attributo 2.1 & attributo 2.2 & attributo 2.3 & attributo 2.4 & \\
		\rowcolor{LightGray}
		attributo 3.1 & attributo 3.2 & attributo 3.3 & attributo 3.4 & \\
		\rowcolor{white}
		attributo 4.1 & attributo 4.2 & attributo 4.3 & attributo 4.4 & \\
		\rowcolor{LightGray}
		attributo 5.1 & attributo 5.2 & attributo 5.3 & attributo 5.4 & \\
		\rowcolor{white}
		attributo 6.1 & attributo 6.2 & attributo 6.3 & attributo 6.4 & \\

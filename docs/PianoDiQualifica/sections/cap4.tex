...
\begin{longtable}{p{3cm} p{4cm} p{5cm} p{2cm}}
	\rowcolor{LightBlue}
		...
		Footer mancante. Piccoli errori grammaticali e di punteggiatura. Completamento descrizione sezione 1.3 Note esplicative. Url citazioni non collegati al sito web. Introdurre rifermento a sezioni come indicato nelle 	

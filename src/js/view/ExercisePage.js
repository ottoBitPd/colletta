...
const fs = require('fs');
class ExercisePage extends PageView{
    constructor(model, sentence,key,hunposIta,hunposTags){
        super(model);
        this.sentence=sentence;
        this.key=key;
        this.hunposIta=hunposIta;
        this.hunposTags=hunposTags;

    }

    getPage() {
        var data =  fs.readFileSync('./html/exercise.html').toString();
